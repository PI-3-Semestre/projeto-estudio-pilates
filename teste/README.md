...
- email-validator faz validação de emails e confirma a existência do domínio: 
`poetry add email-validator`
`

- uuid gera identificadores únicos: `import uuid`

- Pillow Realiza tratamento de imagens: `poetry add Pillow`
