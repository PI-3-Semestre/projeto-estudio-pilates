    ...
    return (
        <div className="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden bg-background-light dark:bg-background-dark font-display">
            <header className="flex items-center bg-background-light dark:bg-background-dark p-4 pb-2 justify-between sticky top-0 z-10 md:hidden">
                <Link to="/alunos/cadastrar-usuario" className="text-text-light dark:text-text-dark flex size-12 shrink-0 items-center justify-center">
                ...
                <div className="bg-card-light dark:bg-card-dark shadow-md rounded-lg w-full max-w-2xl">
                    <div className="p-6 md:p-8">
                        <div className="hidden md:block text-center mb-8">
                            <h1 className="text-2xl font-bold text-text-light dark:text-text-dark">Completar Perfil do Aluno</h1>
                        ...
                        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                            ...
                            <label className="flex flex-col w-full">
                                <p className="text-text-light dark:text-text-dark text-base font-medium leading-normal pb-2">Profissão</p>
                                <input
                                    name="profissao"
                            ...
                            <label className="flex flex-col w-full">
                                <p className="text-text-light dark:text-text-dark text-base font-medium leading-normal pb-2">Unidade Principal</p>
                                <select
                                    name="unidade"
                            ...
                            <div className="flex items-center justify-between mt-2">
                                <p className="text-text-light dark:text-text-dark text-base font-medium leading-normal">Aluno Ativo</p>
