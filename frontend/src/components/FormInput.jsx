    ...
    <div>
      ...
      <div className="mt-1 relative rounded-xl shadow-sm">
        <input
          ...
          value={value}
          onChange={onChange}
          className="block w-full pl-4 pr-10 py-3 text-text-light dark:text-text-dark bg-input-background-light dark:bg-input-background-dark border-transparent focus:border-primary focus:ring-primary rounded-xl placeholder-input-placeholder-light dark:placeholder-input-placeholder-dark"
        />
