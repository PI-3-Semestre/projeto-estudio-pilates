...
const CadastrarColaboradorView = () => {
  ...
  const inputClasses =
    "w-full rounded-md border-0 bg-input-light dark:bg-input-dark text-[#0d1b1a] dark:text-white placeholder-placeholder-light dark:placeholder-placeholder-dark focus:ring-2 focus:ring-inset focus:ring-primary";
  const labelClasses =
    "block text-sm font-medium text-[#0d1b1a] dark:text-gray-200 mb-1";
      ...
      <div className="relative flex min-h-screen w-full flex-col items-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-2xl rounded-xl bg-card-light dark:bg-card-dark p-6 sm:p-8 shadow-lg">
          <div className="text-center mb-6">
            ...
            <p className="text-primary dark:text-primary/70 font-semibold text-sm mt-1">
              Etapa 2 de 2
            </p>
            <p className="text-[#4c9a92] dark:text-primary/70 text-base mt-4">
              Configurando perfil para:{" "}
              <span className="font-bold text-[#0d1b1a] dark:text-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            {/* Perfis */}
            <div>
              <h3 className="text-[#0d1b1a] dark:text-white text-lg font-bold leading-tight tracking-[-0.015em] mb-4">
                Perfis*
              </h3>
                ...
                {perfis.map((perfil) => (
                  <div key={perfil.id} className="flex items-center">
                    ...
                    <label
                      ...
                      className="ml-2 block text-sm text-[#0d1b1a] dark:text-gray-200"
                    >
                      {perfil.nome}
                    </label>
                  </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className={labelClasses} htmlFor="data_nascimento">
                    Data de Nascimento*
                  </label>
                  <input
                    id="data_nascimento"
                ...
                <div>
                  <label className={labelClasses} htmlFor="data_admissao">
                    Data de Admissão*
                  </label>
                  <input
                    id="data_admissao"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2">
                  <label className={labelClasses} htmlFor="cep">
                    CEP*
                  </label>
                  <input
                    id="cep"
                ...
                <div>
                  <label className={labelClasses} htmlFor="logradouro">
                    Logradouro*
                  </label>
                  <input
                    id="logradouro"
                ...
                <div>
                  <label className={labelClasses} htmlFor="numero">
                    Número*
                  </label>
                  <input
                    id="numero"
                ...
                <div className="sm:col-span-2">
                  <label className={labelClasses} htmlFor="complemento">
                    Complemento
                  </label>
                  <input
                    id="complemento"
                ...
                <div>
                  <label className={labelClasses} htmlFor="bairro">
                    Bairro*
                  </label>
                  <input
                    id="bairro"
            ...
            <div>
              ...
              <div className="space-y-6">
                  ...
                  >
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        <label
                          className={labelClasses}
                          htmlFor={`studio_id_${index}`}
                        >
                          Studio*
                        </label>
                        <select
                          id={`studio_id_${index}`}
                          value={vinculo.studio_id}
                          onChange={(e) =>
                            handleVinculoChange(
                              index,
                              "studio_id",
                          ...
                          {[
                            ...
                            <div key={p.id} className="flex items-center">
                              <input
                                ...
                                onChange={() =>
                                  handleVinculoPermissaoChange(index, p.id)
                                }
                                className="h-4 w-4 rounded border-gray-300 dark:border-gray-600 bg-card-light dark:bg-card-dark text-primary focus:ring-primary"
                              />
                              <label
                                htmlFor={`permissao_${index}_${p.id}`}
                                className="ml-2 block text-sm text-[#0d1b1a] dark:text-gray-200"
                              >
                                {p.nome}
                              </label>
                    ...
                    <button
                      ...
                      className="text-red-500 hover:text-red-700 text-sm font-medium mt-3 inline-flex items-center gap-1"
                    >
                ...
                <button
                  type="button"
                  onClick={addVinculo}
                  className="flex w-full items-center justify-center gap-2 rounded-md border-2 border-dashed border-primary/40 px-4 py-2 text-primary font-semibold transition-colors hover:bg-primary/10"
                >
            ...
            <div className="pt-4">
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-lg bg-primary py-3.5 text-base font-bold text-white shadow-sm transition-transform hover:scale-[1.02] active:scale-[0.98]"
              >
