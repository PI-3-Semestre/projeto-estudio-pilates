            ...
            <main className="flex-1 p-4 sm:p-6 lg:p-8">
                <div className="mx-auto max-w-2xl bg-white dark:bg-gray-900 rounded-xl shadow-lg overflow-hidden">
                    <div className="p-6 md:p-8">
                            ...
                            <div className="mt-4 border-t border-gray-200 dark:border-gray-700">
                                <dl className="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
                                        ...
                                        <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:col-span-2 sm:mt-0">{colaborador.cpf}</dd>
                                    </div>
                                </dl>
                            </div>
                        </div>
                        ...
                        {colaborador.unidades && <div className="mt-8">
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white tracking-[-0.015em]">Vínculos com Studios</h3>
                            <div className="mt-4 space-y-4">
                                {colaborador.unidades.map(unidade => (
                                    <div key={unidade.studio_id} className="rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                                        <h4 className="font-semibold text-gray-900 dark:text-white">{unidade.studio_nome}</h4>
                                        <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-2">Permissões nesta Unidade</p>
                                        <ul className="mt-2 space-y-2">
                                            {unidade.permissoes && unidade.permissoes.map(permissao => (
                    ...
                    <div className="bg-gray-50 dark:bg-gray-900/50 px-6 py-4 border-t border-gray-200 dark:border-gray-800">
                        <div className="space-y-3">
                            <button className="w-full flex items-center justify-center gap-2 rounded-lg bg-primary px-5 py-3 text-sm font-medium text-white transition hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 dark:focus:ring-offset-gray-900" type="button">
