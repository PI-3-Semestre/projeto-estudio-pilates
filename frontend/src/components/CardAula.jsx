...
const CardAula = ({ aula }) => {
  ...
  const dataFormatada = format(dataHoraInicio, "dd 'de' MMMM", {
    locale: ptBR,
  });
      ...
      <div className="p-6">
        <div className="flex justify-between items-start">
          ...
          >
            {isLotada
              ? "Lotado"
              : `${aula.vagas_preenchidas}/${aula.capacidade_maxima}`}
          </div>
        </div>
        <div className="mt-4 border-t border-gray-200 dark:border-gray-700 pt-4">
          <div className="flex items-center">
            <span className="material-symbols-outlined text-gray-500 dark:text-gray-400 mr-2">
              person
            </span>
